...
(1, 'First Chapter', 'Hi there! This is the very first article.');
insert into t_article values
...
(1, 'John Doe', 'Com 1', 0, 1);
insert into t_comment values
(3, 'Ann Yone', "Rep 1 Com 1", 1, 1);
insert into t_comment values
(2, 'John Doe', 'Comment 2', 0, 1);
insert into t_comment values
(4, 'Ann Yone', "Rep 1 COM2", 2, 1);
insert into t_comment values
(5, 'unknown', "Rep 2 COM 1", 1, 1);